...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfStamper.CertificateSettings();
  });
  ...
  describe('CertificateSettings', function() {
    it('should create an instance of CertificateSettings', function() {
      // uncomment below and update the code to test CertificateSettings
      //var instane = new PdfStamper.CertificateSettings();
      //expect(instance).to.be.a(PdfStamper.CertificateSettings);
    });

    it('should have the property certificateVersion (base name: "certificateVersion")', function() {
      // uncomment below and update the code to test the property certificateVersion
      //var instane = new PdfStamper.CertificateSettings();
      //expect(instance).to.be();
    });

    it('should have the property cryptoKeysConfigName (base name: "cryptoKeysConfigName")', function() {
      // uncomment below and update the code to test the property cryptoKeysConfigName
      //var instane = new PdfStamper.CertificateSettings();
      //expect(instance).to.be();
    });
