...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfStamper.StampComponent();
  });
  ...
  describe('StampComponent', function() {
    it('should create an instance of StampComponent', function() {
      // uncomment below and update the code to test StampComponent
      //var instane = new PdfStamper.StampComponent();
      //expect(instance).to.be.a(PdfStamper.StampComponent);
    });
