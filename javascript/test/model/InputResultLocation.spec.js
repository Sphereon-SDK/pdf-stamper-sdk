...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfStamper.InputResultLocation();
  });
  ...
  describe('InputResultLocation', function() {
    it('should create an instance of InputResultLocation', function() {
      // uncomment below and update the code to test InputResultLocation
      //var instane = new PdfStamper.InputResultLocation();
      //expect(instance).to.be.a(PdfStamper.InputResultLocation);
    });
