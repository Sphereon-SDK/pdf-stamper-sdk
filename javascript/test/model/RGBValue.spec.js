...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfStamper.RGBValue();
  });
  ...
  describe('RGBValue', function() {
    it('should create an instance of RGBValue', function() {
      // uncomment below and update the code to test RGBValue
      //var instane = new PdfStamper.RGBValue();
      //expect(instance).to.be.a(PdfStamper.RGBValue);
    });
