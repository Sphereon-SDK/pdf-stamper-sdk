...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfStamper.TextComponent();
  });
  ...
  describe('TextComponent', function() {
    it('should create an instance of TextComponent', function() {
      ...
      //var instane = new PdfStamper.TextComponent();
      //expect(instance).to.be.a(PdfStamper.TextComponent);
    });

    it('should have the property nonStrokingColor (base name: "nonStrokingColor")', function() {
      // uncomment below and update the code to test the property nonStrokingColor
      //var instane = new PdfStamper.TextComponent();
