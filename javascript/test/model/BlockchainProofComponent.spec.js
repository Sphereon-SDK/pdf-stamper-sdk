...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfStamper.BlockchainProofComponent();
  });
  ...
  describe('BlockchainProofComponent', function() {
    it('should create an instance of BlockchainProofComponent', function() {
      // uncomment below and update the code to test BlockchainProofComponent
      //var instane = new PdfStamper.BlockchainProofComponent();
      //expect(instance).to.be.a(PdfStamper.BlockchainProofComponent);
    });
