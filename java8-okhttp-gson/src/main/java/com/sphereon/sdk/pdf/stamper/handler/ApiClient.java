...
public class ApiClient {
    ...
    private String basePath = "https://gw.api.cloud.sphereon.com/pdf/stamp/1.0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://gw.api.cloud.sphereon.com/pdf/stamp/1.0
