...
public class BlockchainProofComponent extends StampComponent {
  ...
  private List<BlockchainAnchorsEnum> blockchainAnchors = null;
  ...
  public BlockchainProofComponent addBlockchainAnchorsItem(BlockchainAnchorsEnum blockchainAnchorsItem) {
    if (this.blockchainAnchors == null) {
      this.blockchainAnchors = new ArrayList<>();
    }
  ...
  **/
  @ApiModelProperty(value = "The states at which to create a blockchain anchor. This can be the original file (before stamp)the stamped file, or both")
  ...
  public BlockchainProofComponent proofConfigName(String proofConfigName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BlockchainProofComponent blockchainProofComponent = (BlockchainProofComponent) o;
    return Objects.equals(this.blockchainAnchors, blockchainProofComponent.blockchainAnchors) &&
        Objects.equals(this.proofConfigName, blockchainProofComponent.proofConfigName) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blockchainAnchors, proofConfigName, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class BlockchainProofComponent {\n");
