...
public class Lifecycle {
   ...
   */
  @JsonAdapter(ApplicableJobStatussesEnum.Adapter.class)
  public enum ApplicableJobStatussesEnum {
    ...
    public static ApplicableJobStatussesEnum fromValue(String text) {
      for (ApplicableJobStatussesEnum b : ApplicableJobStatussesEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ApplicableJobStatussesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ApplicableJobStatussesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ApplicableJobStatussesEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return ApplicableJobStatussesEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("applicableJobStatusses")
  private List<ApplicableJobStatussesEnum> applicableJobStatusses = null;
  ...
  public Lifecycle addApplicableJobStatussesItem(ApplicableJobStatussesEnum applicableJobStatussesItem) {
    if (this.applicableJobStatusses == null) {
      this.applicableJobStatusses = new ArrayList<>();
    }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicableJobStatusses, actionTime, action, type);
  }
