...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(StampComponent.class, new TypeSelector() {
            @Override
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
                classByDiscriminatorValue.put("BarcodeComponent".toUpperCase(), BarcodeComponent.class);
                classByDiscriminatorValue.put("BlockchainProofComponent".toUpperCase(), BlockchainProofComponent.class);
