...
public class SynchronousApiTest {
     ...
     */
    @Test
    public void oneshotStampContentTest() throws ApiException {
        String configId = null;
        ContentRequest contentRequest = null;
        ContentResponse response = api.oneshotStampContent(configId, contentRequest);
     ...
     */
    @Test
    public void oneshotStampStreamLocationTest() throws ApiException {
        PdfStamperJobRequest jobRequest = null;
        PdfStamperJobResult response = api.oneshotStampStreamLocation(jobRequest);
